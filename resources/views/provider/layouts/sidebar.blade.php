...
">
            ...
            <li class="nav-item @if(preg_match('/system/i',url()->current())) start active open @endif" style="
    padding-bottom: 5px;
">
                <a href="/provider/system" class="nav-link nav-toggle  margin-left-10" style="
    font-family: AvenirLTStd-Book;
    font-weight: normal;
    font-size: 18px;
    line-height: 27px;
