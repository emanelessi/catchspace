...
@section('content')
    <style>
        ...
        *::after {
        ...
        .bg-warning {
            background-color: #B85282 !important;
        }
        ...
        .btn.btn-primary {
            background: #B85282 !important;
            border: 1px solid #B85282 !important;
            color: #fff !important;
        }
        ...
        .ssignin-form .form-control .form-select .select-arrow {
            position: absolute;
            right: 0px;
            bottom: 30px;
            width: 40px;
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-3">
                    <img class="heading-section" src="{{asset('../img/Group 14.png')}}">
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-4 col-lg-12">
                    <div class="wrap d-md-flex">
                        <div class="img" style="background-image: url({{asset('../img/login.png')}});">
                        </div>
