    ...
    <div class="container">
        <div id="hero1" class="d-flex align-items-center row">
            <div class="  col-lg-6  d-flex flex-column justify-content-center pt-lg-0 order-2 order-lg-1">
                <h1>best<img src="img/bom.png" style="width:60px ; height:60px; margin-left: 10px;"><br>collection of
                </h1>
        ...
        <div class="col-lg-6  order-1 order-lg-2  " data-aos="zoom-in" data-aos-delay="150">
            <img src="img/work.png" style=" margin-left:780px; width: 450px; height:450px; margin-top:-450px ;"
    ...
    <div class="container " data-aos="fade-up">
        <div class="row">
            <div class="  sh shadow   d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                <img src="img/space1.png" class="  col-lg-6  rimg img-fluid" alt="">
...
<section id="star" class="star">
    <div class="container " data-aos="fade-up">
        <div class="row">
            <div class="  sh shadow   d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                <img src="img/Tools.png" class="  col-lg-6  rimg img-fluid" alt="">
                <div class="col-lg-3 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
                    <h3>Tools</h3>
                    <p class="t">
                        Gaza, Universities, Lego Building
...
<section id="star" class="star">
    <div class="container " data-aos="fade-up">
        <div class="row">
            <div class="  sh shadow   d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                <img src="img/space3.png" class="  col-lg-6  rimg img-fluid" alt="">
                <div class="col-lg-3 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
                    <h3>Lego</h3>
                    <p class="t">
                        Gaza, Universities, Lego Building
