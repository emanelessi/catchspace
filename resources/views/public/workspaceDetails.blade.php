    ...
    <section id="star" class="star">
        <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                    <div class="col-lg-6   pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <h4 style="color:#6B60E6; margin-top: 32px; ">
                            <svg style="margin-right:6px; margin-top:-3px" xmlns="http://www.w3.org/2000/svg" width="18"
                                 height="18" fill="currentColor" class="bi bi-currency-exchange" viewBox="0 0 16 16">
                                <path
                        ...
                        <div class="col-lg-6    content" data-aos="fade-left" data-aos-delay="100">
                            <div class="btn-toolbar ">
                                <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right"
                                     data-aos-delay="100">
                                    <button class="btn main-btn5 shadow" style="margin-right:30px ;margin-top: -90px; ">
                                        Desk office
                                    </button>
                                    <button class="btn main-btn5 shadow" style="margin-right:30px ;margin-top: -90px;">
                                        Private room
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
                    <div class="content text-center" style="margin-left:220px ; margin-top: 60px;">
                        <div class="ratings">
                            ...
                            <div class="stars">
                                <svg xmlns="http://www.w3.org/2000/svg" style="color: #FFC107;" width="16" height="16"
                ...
                <div class="container " data-aos="fade-up">
                    <div class="row">
                        <div class="  d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                            ...
                            <h6 class=" col-sm-2 " style="margin-top: -70px;  ; margin-bottom: 70px; color: #AAB2B1;">
                                <div class="col-lg-3 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
            ...
            box-shadow: 0px 10px 10px #E0E0E0; margin-left:30px;">
                                    ...
                                    <div class="col-lg-4  pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
                                        <div class="ratings"
                                             style=" margin-left: -20px; margin-top: -45px; background-color: #FFC107;  ; width: 400px; height: 150px;">
                                            <div class="ratingtext">
                                                <h5 style="color: #fff; text-align: center; margin-top: 20px;">Are You A
                                                    Member Of
                                                    Lego</h5>
                                                <h6 style="color:  #6B60E6; text-align: center;">We are interested in
