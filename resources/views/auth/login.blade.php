...
@section('content')
    ...
    <body class=" login" style="background-color: #6B6767;
            background-image: linear-gradient(#726767, #090808);height: 768px;
    ">
    <!-- BEGIN LOGO -->
    <div class="container">
...
"></div>
    ...
    <!-- BEGIN LOGIN -->
    <div class="content" style="border-radius: 20px !important;width: 464px;height: 390px;
    top: -500px;background: #FFFFFF;margin-top:225px;margin-left:455px;">
        <!-- BEGIN LOGIN FORM -->
        <form method="POST" action="{{ route('login') }}" style="
    margin-left: 25px !important;
">
            @csrf
            <h3 class="form-title" style="width: 123px; margin-bottom: 9px;
height: 52px;
left: 541px;
top: 213px;
font-family: 'Avenir LT Std', sans-serif;
...
color: #000000;
">{{ __('Log In') }}</h3>
            <h5 class="control-label" style="width: 275px; margin-bottom: 19px;
height: 25px;
left: 540px;
top: 276px;
font-family: 'Avenir LT Std', sans-serif;
...
">{{ __('Forgot password?') }}</a>
            ...
            <button type="submit" class="btn blue" style="display: flex;
...
color: #FFFFFF;">  {{ __('Login') }}</button>
    ...
    <div>
        <p style="width: 260px;height: 20px;font-family: 'Avenir LT Std', sans-serif;font-style: normal;
        font-weight: normal;font-size: 16px;line-height: 24px;color: #FFFFFF;
        margin-top: -505px;margin-left: 570px;left: 593px;top: 572px;">Don’t have an account?
