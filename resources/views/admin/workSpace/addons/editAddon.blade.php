...
/* or 120% */letter-spacing: -0.022em;color: #333333;font-family: Poppins-Semibold;margin-bottom: 20px;">Edit Addon</h1>
            </div>
            <!-- END PAGE TITLE -->
            <div class="row">
                <div class="col-md-12">
                                                    ...
                                                    <form role="form" action="{{route('updateAddon')}}" method="POST">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="number" name="value"
                                                                   placeholder="value"
                                                                   class="form-control" value="{{$workSpaceAddons->value}}"
                                                                   style="
                                                                       height: 40px;
                                                                       /*padding: 0 12px;*/
                                                                       border-radius: 8px !important;
                                                                       border: solid 1px #d1d5db;"/>
                                                            <input type="hidden" name="id" value="{{$workSpaceAddons->id}}" />
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label class="control-label margin-left-9"
                                                                ...
                                                                name *</label>
                                                            <input type="text" name="name" value="{{$workSpaceAddons->addon->name}}"
                                                                   placeholder="name"
                                                                   class="form-control"
                                                                   style="
                                                                       height: 40px;
