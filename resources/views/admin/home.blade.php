...
">
                                                            <span class="mt-action-author"
                                                                  style="margin-right: 25px;width: 109.1px;height: 28.27px;left: 396.39px;top: 761.46px;font-family: Poppins Medium;font-style: normal;font-weight: 500;font-size: 18px;line-height: 27px;color: #000000;">John Clark</span>Text
...
">9:30pm</span>
    ...
    color: #7C7C7C;
"><span class="mt-action-author"
        style="margin-right: 25px;width: 109.1px;height: 28.27px;left: 396.39px;top: 761.46px;font-family: Poppins Medium;font-style: normal;font-weight: 500;font-size: 18px;line-height: 27px;color: #000000;">Donna Clarkson </span>Simply
...
">9:30pm</span>
    ...
    color: #7C7C7C;
"><span class="mt-action-author"
        style="margin-right: 25px;width: 109.1px;height: 28.27px;left: 396.39px;top: 761.46px;font-family: Poppins Medium;font-style: normal;font-weight: 500;font-size: 18px;line-height: 27px;color: #000000;">Tom Larson</span>Lorem
                                            ...
                                            <div class="mt-action-row">
                                                <div class="mt-action-info ">
                                                    ...
                                                    <div class="mt-action-details ">
                                                        ...
                                                        <p class="mt-action-desc"><span class="mt-action-author"
                                                                                        style="margin-right: 25px;">Frank Cameron</span>Lorem
                                            ...
                                            <div class="mt-action-row">
                                                <div class="mt-action-info ">
                                                    ...
                                                    <div class="mt-action-details ">
                                                        ...
                                                        <p class="mt-action-desc"><span class="mt-action-author"
                                                                                        style="margin-right: 25px;">Ella Davidson </span>Text
                                            ...
                                            <div class="mt-action-row">
                                                <div class="mt-action-info ">
                                                    ...
                                                    <div class="mt-action-details ">
                                                        ...
                                                        <p class="mt-action-desc"><span class="mt-action-author"
                                                                                        style="margin-right: 25px;">Jason Dickens </span>Dummy
                                            ...
                                            <div class="mt-action-row">
                                                <div class="mt-action-info ">
                                                    ...
                                                    <div class="mt-action-details ">
                                                        ...
                                                        <p class="mt-action-desc"><span class="mt-action-author"
                                                                                        style="margin-right: 25px;">Jan Kim</span>Lorem
                                                            Ipsum is simply dummy</p>
                                                    </div>
                                                </div>
                                                <div class="mt-action-buttons ">
                                                    <div>
                                                        <button type="button" class="btn Reject"
                                                                style="display: flex;flex-direction: row;align-items: center;position: absolute;width: 80.15px;height: 42.03px;background: #333333;opacity: 0.5;border-radius: 14px !important;font-family: Poppins;font-style: normal;font-weight: 500;font-size: 16px;line-height: 24px;letter-spacing: 0.4px;color: #FFFFFF;">
                                                            Reject
                                                        </button>
